(function () {
  ...
  var LANG_KEY = "dd_christophe_lang_v2";
  var LEAD_KEY = "dd_christophe_leads_v1";
  ...
  window.initChristophePage = function (opts) {
    DATA = window.CHRISTOPHE;
    opts = opts || {};
